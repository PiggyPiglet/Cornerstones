...
import me.piggypiglet.cornerstones.scanning.annotations.Hidden;
import me.piggypiglet.cornerstones.scanning.rules.annotation.AnnotationWrapper;
import me.piggypiglet.cornerstones.scanning.rules.element.AnnotationUtils;
...
// ------------------------------
public record Rules<R>(@NotNull List<Predicate<ElementWrapper>> rules) {
