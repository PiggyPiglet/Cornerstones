package me.piggypiglet.cornerstones.boot.framework;
...
import me.piggypiglet.cornerstones.guice.modules.DynamicModule;
...
public abstract class Registerable {
    ...
    @NotNull
    public Optional<AbstractModule> createModule() {
